...
#--num_blocks 3 --epochs 100 --random_flipping True \
#--min_dimension_size 32 --g_lr 0.0002 --alpha_1 1.0 --alpha_2 0.00 \
#--model ESRGAN --generator_steps 1
...
#--epochs 250 --min_dimension_size 32 --cropping_resolution 96 --g_lr 0.00002 \
#--alpha_1 1.0 --alpha_2 0.00 \
#--model ESRGAN --generator_steps 1
